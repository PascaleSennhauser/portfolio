...
export class AboutMeComponent {
  ...
  text: any = {
    ...
    ge: {
      ...
      aboutMe: "Meine Leidenschaft für die Programmierung ergibt sich aus der Freude am logischen Denken, sowie ein ansprechendes Projekt zu verwirklichen. Um auf dem Laufenden zu bleiben und meine Fähigkeiten kontinuierlich weiterzuentwickeln, investiere ich Zeit, um mich fortzubilden. Durch meine vielseitigen Berufserfahrungen, darunter Erfahrung im kaufmännischen Bereich, sowie im Gesundheits- und Sozialwesen, habe ich mir wertvolle Kompetenzen angeeignet. Darunter gehören Fähigkeiten, wie schnell viel Neues zu lernen, auf Kundenbedürfnisse einzugehen und flexibel zu sein, was mir als Entwicklerin zugutekommt. Ausserdem macht es mir Spass, komplexe Probleme zu lösen und mit Kunden, sowie im Team zusammenzuarbeiten.",
